...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "HomeOfficeLife — Transforme seu home office com IA" },
      ...
      { name: "twitter:title", content: "HomeOfficeLife — Transforme seu home office com IA" },
      { name: "twitter:description", content: "Envie uma foto do seu espaço e receba ideias decoradas + diagnóstico + produtos pra montar um home office melhor." },
