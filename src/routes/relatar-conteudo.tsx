...
export const Route = createFileRoute("/relatar-conteudo")({
  head: () => ({
    meta: [
      { title: "Relatar conteúdo · HomeOfficeLife" },
      { name: "description", content: "Procedimento de notificação e remoção (notice & takedown) para reclamar de conteúdo que viole direitos autorais, imagem ou marca no HomeOfficeLife." },
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto max-w-3xl px-4 py-12 md:px-6 md:py-16">
        ...
        <p className="mt-3 text-lg text-muted-foreground">
          Encontrou um setup, comentário ou produto na HomeOfficeLife que viola seus
        ...
        <div className="mt-10 space-y-6">
          <section className="rounded-3xl border border-border bg-card p-6 shadow-soft">
            ...
            <p className="mt-3 text-sm text-muted-foreground">
              ...
              <a href="mailto:juridico@homeofficelife.com.br" className="font-semibold text-primary hover:underline">
                juridico@homeofficelife.com.br
              </a>{" "}
              com o seguinte:
            </p>
            <ol className="ml-6 mt-3 list-decimal space-y-2 text-sm">
              ...
              <li><strong>URL específica:</strong> link direto do conteúdo questionado (ex: <code className="rounded bg-secondary px-1">https://homeofficelife.com.br/setup/...</code>).</li>
          ...
          <section className="rounded-3xl border-l-4 border-coral bg-coral/10 p-6">
            ...
            <p className="mt-2 text-sm text-foreground">
              ...
              responsabilização civil do notificante por danos materiais e morais ao usuário afetado e ao HomeOfficeLife.
            </p>
            <p className="mt-2 text-sm text-foreground">
          ...
          <section className="rounded-3xl border border-border bg-card p-6 shadow-soft">
            ...
            <ul className="mt-3 space-y-2 text-sm">
              <li><strong>Privacidade / LGPD / DPO:</strong> <a href="mailto:privacidade@homeofficelife.com.br" className="text-primary hover:underline">privacidade@homeofficelife.com.br</a></li>
              <li><strong>Suporte geral:</strong> <a href="mailto:contato@homeofficelife.com.br" className="text-primary hover:underline">contato@homeofficelife.com.br</a></li>
              <li><strong>Comercial / B2B:</strong> <a href="mailto:contato@homeofficelife.com.br" className="text-primary hover:underline">contato@homeofficelife.com.br</a></li>
            </ul>
          </section>
        </div>
      </main>
