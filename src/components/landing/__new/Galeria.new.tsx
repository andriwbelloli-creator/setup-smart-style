...
const SETUPS = [
  { id:1,  img:"assets/hero-setup.webp",    title:"Dev teal com mesa cavalete",    author:"Rafael Costa",    role:"Dev Full Stack",       city:"São Paulo, SP",      cats:["Dev","Minimalista"],     score:9.5, budget:5200, likes:412, saves:128, level:"Profissional" },
  { id:2,  img:"assets/setup-after.webp",   title:"Setup criativo com plantas",    author:"Mariana Alves",   role:"Designer",             city:"Porto Alegre, RS",   cats:["Designer","Creator"],   score:9.2, budget:6800, likes:356, saves:94,  level:"Profissional" },
  { id:3,  img:"assets/setup-minimal.webp", title:"Apê branco vista de cima",      author:"Ana Pereira",     role:"UX Designer",          city:"São Paulo, SP",      cats:["Minimalista","MacBook"], score:9.0, budget:4200, likes:312, saves:89,  level:"Otimizado" },
  { id:4,  img:"assets/setup-compact.webp", title:"Cantinho compacto com plantas", author:"Carla Souza",     role:"PM",                   city:"Rio de Janeiro, RJ", cats:["Apê pequeno"],          score:8.5, budget:2400, likes:188, saves:56,  level:"Bom" },
  { id:5,  img:"assets/setup-gamer.webp",   title:"Dual monitor RGB gamer",        author:"Lucas Reis",      role:"Dev Backend",          city:"Belo Horizonte, MG", cats:["Gamer","Dev"],          score:8.3, budget:8500, likes:244, saves:71,  level:"Otimizado" },
  { id:6,  img:"assets/setup-creator.webp", title:"Estúdio creator ring light",    author:"Juliana Martins", role:"Criadora de conteúdo", city:"Curitiba, PR",       cats:["Creator"],              score:8.8, budget:3900, likes:289, saves:82,  level:"Otimizado" },
  { id:7,  img:"assets/setup-before.webp",  title:"Setup clean mesa branca",       author:"Pedro Oliveira",  role:"Dev Frontend",         city:"Florianópolis, SC",  cats:["Dev","Minimalista"],     score:7.8, budget:3100, likes:156, saves:43,  level:"Bom" },
  { id:8,  img:"assets/hero-setup.webp",    title:"Wood desk parede teal",         author:"Thiago Mendes",   role:"Tech Lead",            city:"Campinas, SP",       cats:["Dev"],                  score:9.1, budget:5800, likes:378, saves:102, level:"Profissional" },
  { id:9,  img:"assets/setup-after.webp",   title:"Workspace designer premium",    author:"Camila Ferreira", role:"Designer",             city:"Recife, PE",         cats:["Designer"],             score:8.9, budget:7200, likes:267, saves:78,  level:"Otimizado" },
  { id:10, img:"assets/setup-minimal.webp", title:"iMac setup minimalista",        author:"Fernanda Lima",   role:"Psicóloga",            city:"Brasília, DF",       cats:["Minimalista","MacBook","Apê pequeno"], score:8.7, budget:4800, likes:201, saves:63, level:"Otimizado" },
];
