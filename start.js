...
const CSP_POLICY = [
  ...
  "img-src 'self' data: blob: https://*.supabase.co https://images.unsplash.com https://homeofficelife.com.br",
  "font-src 'self' data:",
...
async function handleSitemap(_req, res) {
  const staticUrls = [
    { loc: "https://homeofficelife.com.br/", priority: 1.0, changefreq: "daily" },
    { loc: "https://homeofficelife.com.br/galeria", priority: 0.9, changefreq: "daily" },
    { loc: "https://homeofficelife.com.br/diagnostico", priority: 0.9, changefreq: "weekly" },
    { loc: "https://homeofficelife.com.br/kits", priority: 0.9, changefreq: "weekly" },
    { loc: "https://homeofficelife.com.br/blog", priority: 0.9, changefreq: "weekly" },
    { loc: "https://homeofficelife.com.br/consultoria", priority: 0.8, changefreq: "weekly" },
    { loc: "https://homeofficelife.com.br/orcamento", priority: 0.8, changefreq: "weekly" },
    { loc: "https://homeofficelife.com.br/comunidade", priority: 0.7, changefreq: "daily" },
    { loc: "https://homeofficelife.com.br/premium", priority: 0.7, changefreq: "monthly" },
    // Blog posts — hardcoded slugs (atualizar manualmente quando publicar
    // novo post no src/data/blog-posts.ts).
    { loc: "https://homeofficelife.com.br/blog/home-office-r-500-completo-2026", priority: 0.8, changefreq: "monthly" },
    { loc: "https://homeofficelife.com.br/blog/setup-r-3000-vs-r-30000-vale-pena", priority: 0.8, changefreq: "monthly" },
    { loc: "https://homeofficelife.com.br/blog/por-que-sua-nota-ia-ta-baixa-6-erros", priority: 0.8, changefreq: "monthly" },
    { loc: "https://homeofficelife.com.br/termos", priority: 0.3, changefreq: "monthly" },
    { loc: "https://homeofficelife.com.br/privacidade", priority: 0.3, changefreq: "monthly" },
    { loc: "https://homeofficelife.com.br/relatar-conteudo", priority: 0.3, changefreq: "monthly" },
  ];
...
server.listen(PORT, "0.0.0.0", () => {
  console.log(`HomeOfficeLife server listening on http://0.0.0.0:${PORT}`);
});
